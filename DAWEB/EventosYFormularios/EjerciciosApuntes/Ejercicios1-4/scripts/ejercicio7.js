...
window.onload = function() {
    document.getElementById('idh1').onclick = aceptar;
    document.getElementById('idh2').onclick = cancelar;
...
window.onload = function() {
    document.getElementById('idh3').onclick = insertarEncabezadoH2;
...
/* Ejercicio 1 Eventos Y Formularios
...
/* Ejercicio 3 Eventos Y Formularios 
